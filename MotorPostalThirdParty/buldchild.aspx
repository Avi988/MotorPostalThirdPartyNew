...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="auto-style1">
        ...
        <fieldset id="fieldSet_DateRange" runat="server" style="border-color: #4682B4; " class="auto-style7">


        <legend style="background-color: #4682B4; color: #FFFFFF; text-align: left; font-size: 15px">
            Post SMS Sending</legend>
                ...
                <tr>
                    <td class="auto-style4">
                        &nbsp;<table style="width:100%;">
                            ...
                            <tr>
                                <td class="auto-style12" style="color: #000080">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label4" runat="server" Text="From :"></asp:Label>
                                    &nbsp;&nbsp;<asp:TextBox ID="Txtboxfrom" runat="server" CssClass="auto-style13" Width="180px"></asp:TextBox>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                </td>
                            ...
                            <tr style="color: #000080">
                                <td class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:TextBox ID="TxtboxTo" runat="server" Width="179px" Height="17px" CssClass="auto-style15"></asp:TextBox>
                                    &nbsp;</td>
                            </tr>
                        </table>
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td class="auto-style12" style="color: #000080">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label12" runat="server" Text="Policy No :"></asp:Label>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td class="auto-style8">
                                    ...
                                    <asp:Button ID="Button4" runat="server" CssClass="auto-style8" style="margin-left: 119px" Text="SEARCH" Height="33px" Width="69px" BackColor="#4682B4" ForeColor="#FFFFFF"/>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
